...
const char cmd_rdVoltPwrSply[]    PROGMEM = "volt";      const char cmd_help_rdVoltPwrSply[]     PROGMEM = "Read power supply voltage";
const char cmd_rdCurrPwrSply[]    PROGMEM = "current";   const char cmd_help_rdCurrPwrSply[]     PROGMEM = "Read power supply current";
